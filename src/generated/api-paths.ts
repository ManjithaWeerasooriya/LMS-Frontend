...
export const apiPaths = {
  ...
  "/api/v1/admin/system/test-azure-connections": "/api/v1/admin/system/test-azure-connections",
  ...
  "/api/v1/live-sessions/{sessionId}/attendance/join": "/api/v1/live-sessions/{sessionId}/attendance/join",
  "/api/v1/live-sessions/{sessionId}/attendance/leave": "/api/v1/live-sessions/{sessionId}/attendance/leave",
  "/api/v1/live-sessions/{sessionId}/join-token": "/api/v1/live-sessions/{sessionId}/join-token",
  "/api/v1/live-sessions/{sessionId}/recording": "/api/v1/live-sessions/{sessionId}/recording",
  ...
  "/api/v1/student/courses/{courseId}/live-sessions": "/api/v1/student/courses/{courseId}/live-sessions",
  "/api/v1/student/courses/{courseId}/materials": "/api/v1/student/courses/{courseId}/materials",
  "/api/v1/student/courses/my": "/api/v1/student/courses/my",
  "/api/v1/student/dashboard": "/api/v1/student/dashboard",
  "/api/v1/student/live-sessions/{sessionId}": "/api/v1/student/live-sessions/{sessionId}",
  "/api/v1/student/materials/{materialId}": "/api/v1/student/materials/{materialId}",
  "/api/v1/student/materials/{materialId}/download": "/api/v1/student/materials/{materialId}/download",
  ...
  "/api/v1/teacher/live-sessions/{sessionId}/recording/start": "/api/v1/teacher/live-sessions/{sessionId}/recording/start",
  "/api/v1/teacher/live-sessions/{sessionId}/recording/stop": "/api/v1/teacher/live-sessions/{sessionId}/recording/stop",
  "/api/v1/teacher/live-sessions/{sessionId}/start": "/api/v1/teacher/live-sessions/{sessionId}/start",
  ...
  "/api/v1/Users/profile-image": "/api/v1/Users/profile-image",
} as const;
